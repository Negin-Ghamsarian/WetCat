...
from nets_DeepPyramid import DeepPyramid_ResNet34_FFD_LayerNorm as Net1
...
Framework_name = "Supervised_DeepPyramid_ResNet34_FFD_LayerNorm_JustInstruments"
...
datasets = [
['Wetlab_AnatomyInst_train_fold0.csv', 'Wetlab_AnatomyInst_train_fold0.csv', 'Wetlab_AnatomyInst_test_fold0.csv', 1],
['Wetlab_AnatomyInst_train_fold1.csv', 'Wetlab_AnatomyInst_train_fold1.csv', 'Wetlab_AnatomyInst_test_fold1.csv', 1],
['Wetlab_AnatomyInst_train_fold2.csv', 'Wetlab_AnatomyInst_train_fold2.csv', 'Wetlab_AnatomyInst_test_fold2.csv', 1],
['Wetlab_AnatomyInst_train_fold3.csv', 'Wetlab_AnatomyInst_train_fold3.csv', 'Wetlab_AnatomyInst_test_fold3.csv', 1]
]
...
TrainIDs_path = '/storage/homefs/ng22l920/Codes/Wetlab_Phase/TrainIDs_Seg_AnatomyInst/'
